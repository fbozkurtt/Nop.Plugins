...
namespace Nop.Plugin.Misc.CategorySpecAttribute.Components
{
    ...
    public class CategorySpecificationAttributeGroupViewComponent : NopViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync(string widgetZone, object additionalData)
        {
            ...
            return View("~/Plugins/Misc.AdvancedSpecificationAttributes/Views/SpecificationAttribute/_CreateOrUpdateSpecificationAttributeGroup.Categories.cshtml", specificationAttributeGroupCategoryModel);
        }
